...
const UpVote = (prop: UpVoteProps) => {
  ...
  return (
    <button
      className={`flex cursor-pointer flex-wrap items-center justify-center gap-x-[10px] gap-y-2 rounded-10 px-3 py-2 text-xs font-bold hover:bg-gray-500 ${upvoted ? "bg-blue-200 text-white" : "bg-gray-100 text-dark-200"} custom-focus min-w-10`}
